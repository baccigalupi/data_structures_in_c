...
char *test_list_first_push() {
  ...
  mu_assert(list_count(list) == 1,   "list_push did not set list count properly");
...
char *test_list_second_push() {
  ...
  mu_assert(list_count(list) == 2,     "list_push did not set list count properly");
...
char *test_list_additional_pushes() {
  ...
  mu_assert(list_count(list) == 3,     "list_push did not set count correctly after subsequent pushes");
...
char *test_list_pop() {
  ...
  mu_assert(list_count(list) == 2,    "list_pop did not decrement count");
...
char *test_multiple_pops() {
  ...
  char *value = list_pop(list);
  mu_assert(list_count(list) == 2,    "list_pop did not decrement list count");
  value = list_pop(list);
  mu_assert(list_count(list) == 1,    "list_pop did not decrement list count");
  value = list_pop(list);
  mu_assert(list_count(list) == 0,    "list_pop did not decrement list count");
...
char *test_list_unshift() {
  ...
  mu_assert(list_count(list) == 1,     "list_unshift did not set list count properly");
...
char *test_list_unshift_second_time() {
  ...
  mu_assert(list_count(list) == 2,     "list_unshift did not set list count properly");
...
char *test_list_unshift_additional_time() {
  ...
  mu_assert(list_count(list) == 3,     "list_unshift did not set list count properly");
  mu_assert(list_last(list)  == str_1, "list_unshift did not set the value of the last node");
...
char *test_list_shift() {
  ...
  mu_assert(list_count(list) == 2,    "list_shift did not decrement count");
...
char *test_multiple_shifts() {
  ...
  mu_assert(list_count(list) == 1,    "list_shift did not decrement count");
  value = list_shift(list);

  mu_assert(value == str_3,           "list_shift did not return value");
  mu_assert(list_count(list) == 0,    "list_shift did not decrement count");
...
char *test_destroy() {
  ...
  list_destroy(list); // just see that it works without fail
